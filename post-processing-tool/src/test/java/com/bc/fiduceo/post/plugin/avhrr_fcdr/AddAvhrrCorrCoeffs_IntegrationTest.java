...
public class AddAvhrrCorrCoeffs_IntegrationTest {
    ...
    public void testAddAvhrrCorrCoeffs() throws IOException, InvalidRangeException {
        ...
        try (NetcdfFile mmd = NetcdfFile.open(targetFile.getAbsolutePath())) {
            ...
            NCTestUtils.assert3DVariable("avhrr-ma-fcdr_cross_element_correlation_coefficients", 0, 0, 0, Float.NaN, mmd);
            NCTestUtils.assert3DVariable("avhrr-ma-fcdr_cross_element_correlation_coefficients", 1, 1, 1, Float.NaN, mmd);
            NCTestUtils.assert3DVariable("avhrr-ma-fcdr_cross_element_correlation_coefficients", 2, 2, 0, Float.NaN, mmd);
            NCTestUtils.assert3DVariable("avhrr-ma-fcdr_cross_element_correlation_coefficients", 3, 3, 1, 1.0, mmd);
            NCTestUtils.assert3DVariable("avhrr-ma-fcdr_cross_element_correlation_coefficients", 4, 4, 0, 1.0, mmd);
            NCTestUtils.assert3DVariable("avhrr-ma-fcdr_cross_element_correlation_coefficients", 5, 5, 1, 1.0, mmd);

            NCTestUtils.assert3DVariable("avhrr-ma-fcdr_cross_line_correlation_coefficients", 0, 0, 0, Float.NaN, mmd);
            NCTestUtils.assert3DVariable("avhrr-ma-fcdr_cross_line_correlation_coefficients", 1, 1, 1, 0.0, mmd);
            NCTestUtils.assert3DVariable("avhrr-ma-fcdr_cross_line_correlation_coefficients", 2, 2, 0, Float.NaN, mmd);
            NCTestUtils.assert3DVariable("avhrr-ma-fcdr_cross_line_correlation_coefficients", 3, 3, 1, Float.NaN, mmd);
            NCTestUtils.assert3DVariable("avhrr-ma-fcdr_cross_line_correlation_coefficients", 4, 4, 0, 1.0, mmd);
            NCTestUtils.assert3DVariable("avhrr-ma-fcdr_cross_line_correlation_coefficients", 5, 5, 1, 0.8844125270843506, mmd);
        }
    }
