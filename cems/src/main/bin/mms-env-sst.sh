...
submit_job() {
    ...
    bsubmit="bsub -R rusage[mem=8192] -q short-serial -W 12:00 -P sst-cci -cwd ${MMS_INST} -oo ${MMS_LOG}/${jobname}.out -eo ${MMS_LOG}/${jobname}.err -J ${jobname} ${MMS_HOME}/bin/${command} ${@:3}"
