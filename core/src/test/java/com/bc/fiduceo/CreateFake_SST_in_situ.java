...
public class CreateFake_SST_in_situ {
    ...
    public static void main(String[] args) throws IOException, InvalidRangeException {
        ...
        try (NetcdfFileWriter fileWriter = NetcdfFileWriter.createNew(NetcdfFileWriter.Version.netcdf4, targetFile.getAbsolutePath(), chunking)) {
            ...
            fileWriter.addVariableAttribute(latVariable, new Attribute(NetCDFUtils.CF_FILL_VALUE_NAME, -9999.0));

            final Variable lonVariable = fileWriter.addVariable(null, "insitu.lon", DataType.FLOAT, "record");
            fileWriter.addVariableAttribute(lonVariable, new Attribute(NetCDFUtils.CF_FILL_VALUE_NAME, -9999.0));
            ...
            fileWriter.write(timeVariable, Array.factory(new int[]{1372672650, 1372672773, 1372673028, 1372673256, 1372673566}));
