...
public class SirdsMbtInsituReaderPluginTest {

    private SirdsMbtInsituReaderPlugin plugin;

    @Before
    public void setUp() {
        plugin = new SirdsMbtInsituReaderPlugin();
    }

    @Test
    public void testGetSupportedSensorKeys() throws Exception {
        final String[] expected = {"mbt-sirds"};
    ...
    public void testCreateReader() {
        ...
        assertEquals("mbt-sirds", ((SirdsInsituReader) reader).getSensorKey());
    }
