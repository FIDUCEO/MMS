...
public class PixelLocatorSegmentedTest {
    ...
    @Before
    public void setUp() {
        pixelLocator = new PixelLocatorSegmented();
    }
    ...
    public void testOneGeoCoding() {
        ...
        final Interval interval = new Interval(198, 2355);
        ...
        assertEquals(2167, pixelLocation[0].getY(), 1e-8);
    }
    ...
    public void testThreeGeoCodings() {
        ...
        when(geoCoding_0.getPixelPos(any(), any())).thenReturn(new PixelPos(109, 2168));
        ...
        when(geoCoding_1.getPixelPos(any(), any())).thenReturn(new PixelPos(110, 2169));
        ...
        when(geoCoding_2.getPixelPos(any(), any())).thenReturn(new PixelPos(111, 2170));
