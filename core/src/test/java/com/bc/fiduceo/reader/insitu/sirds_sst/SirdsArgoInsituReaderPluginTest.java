...
public class SirdsArgoInsituReaderPluginTest {

    private SirdsArgoInsituReaderPlugin plugin;

    @Before
    public void setUp() {
        plugin = new SirdsArgoInsituReaderPlugin();
    }

    @Test
    public void testGetSupportedSensorKeys() throws Exception {
        final String[] expected = {"argo-sirds"};
    ...
    public void testCreateReader() {
        ...
        assertEquals("argo-sirds", ((SirdsInsituReader) reader).getSensorKey());
    }
