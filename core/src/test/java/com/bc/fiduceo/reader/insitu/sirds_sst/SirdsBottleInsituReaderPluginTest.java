...
public class SirdsBottleInsituReaderPluginTest {

    private SirdsBottleInsituReaderPlugin plugin;

    @Before
    public void setUp() {
        plugin = new SirdsBottleInsituReaderPlugin();
    }

    @Test
    public void testGetSupportedSensorKeys() throws Exception {
        final String[] expected = {"bottle-sirds"};
    ...
    public void testCreateReader() {
        ...
        assertEquals("bottle-sirds", ((SirdsInsituReader) reader).getSensorKey());
    }
