...
public class SirdsXbtInsituReaderPluginTest {

    private SirdsXbtInsituReaderPlugin plugin;

    @Before
    public void setUp() {
        plugin = new SirdsXbtInsituReaderPlugin();
    }

    @Test
    public void testGetSupportedSensorKeys() throws Exception {
        final String[] expected = {"xbt-sirds"};
    ...
    public void testCreateReader() {
        ...
        assertEquals("xbt-sirds", ((SirdsInsituReader) reader).getSensorKey());
    }
