...
public class SSMT2_Reader_IO_Test {
    ...
    public void testRead1dFrom2dVariable_with_channel() throws IOException, InvalidRangeException {
        ...
        try (SSMT2_Reader reader = this.ssmt2Reader) {
            ...
            float[] f = (float[]) d2.get1DJavaArray(Float.class);
            final float[] expected = new float[]{
                    9.96921E36f, 9.96921E36f, 0.12364213f, 0.12364213f, 0.12364213f,
                    9.96921E36f, 9.96921E36f, 0.12347869f, 0.12347869f, 0.12347869f,
                    9.96921E36f, 9.96921E36f, 0.123529024f, 0.123529024f, 0.123529024f,
                    9.96921E36f, 9.96921E36f, 0.12290908f, 0.12290908f, 0.12290908f,
                    9.96921E36f, 9.96921E36f, 0.12332391f, 0.12332391f, 0.12332391f
            };
            assertArrayEquals(f, expected, 1e-8f);
        }
    }
    ...
    private File createSSMT2_F11_File() throws IOException {
    ...
    private File createSSMT2_F14_File() throws IOException {
