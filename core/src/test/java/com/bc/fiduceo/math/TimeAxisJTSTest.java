...
public class TimeAxisJTSTest {
    ...
    public void testGetIntersectionTime_noIntersection() throws ParseException {
        ...
        final TimeAxisJTS timeAxis = new TimeAxisJTS(lineString, new Date(100000000000L), new Date(100001000000L));
    ...
    public void testGetTime_PointOnLine() throws ParseException {
        ...
        final TimeAxisJTS timeAxis = new TimeAxisJTS(lineString, new Date(1000000000000L), new Date(1000001000000L));
