...
import com.bc.fiduceo.math.Rotation;
...
abstract class AbstractPixelLocator implements PixelLocator {
    ...
    private final int w;
    private final int h;
    private Raster lonData;
    private Raster latData;

    protected AbstractPixelLocator(PlanarImage lonSource, PlanarImage latSource) {
        ...
        w = lonSource.getWidth();
        h = lonSource.getHeight();
    }
    ...
    protected final double getLat(int x, int y) {
        return latData.getSampleDouble(x, y, 0);
    }
